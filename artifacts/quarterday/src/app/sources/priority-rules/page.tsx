      ...
      <div style={{ padding: "28px 32px" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
          ...
          <div style={{ display: "flex", gap: 12, fontSize: 13, color: "#6b7280" }}>
            <span><strong style={{ color: "#111827" }}>{configured}</strong> configured</span>
            {notConfigured > 0 && (
        ...
        <div className="panel">
          <p style={{ color: "#6b7280", marginBottom: 16, fontSize: 13 }}>
            ...
            is not authoritative, Quarterday will show a warning and require an override reason.
          </p>
            ...
            <table className="data-table">
              ...
              <tbody>
                {categories.map((cat) => {
                  ...
                  return (
                    <tr key={cat.id} style={noAuth ? { background: "#fffbeb" } : {}}>
                      <td>
                      ...
                      <td>{rule?.secondarySource?.name || <span style={{ color: "#9ca3af" }}>—</span>}</td>
                      <td>{rule?.tertiarySource?.name || <span style={{ color: "#9ca3af" }}>—</span>}</td>
                      <td>
                      ...
                      <td>{rule?.reviewOwner || <span style={{ color: "#9ca3af" }}>—</span>}</td>
                      <td>
