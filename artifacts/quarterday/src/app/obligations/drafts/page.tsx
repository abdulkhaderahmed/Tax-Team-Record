              ...
              {drafts.map((ob) => {
                ...
                return (
                  <tr key={ob.id}>
                    ...
                    <td style={{ maxWidth: 320, fontSize: 11, color: "#6b7280" }}>
                      <div style={{ marginBottom: 4 }}>
                        <strong style={{ color: "#374151" }}>Why:</strong>{" "}
                        {ob.humanExplanation ?? "—"}
                      </div>
                      <div>
                        <strong style={{ color: "#374151" }}>Calc:</strong>{" "}
                        {ob.calculationBasis ?? "—"}
                      </div>
                      {ob.draftNote && (
                      ...
                      {ob.statutoryBasis && (
                        <div style={{ marginTop: 4 }}>
                          <strong style={{ color: "#374151" }}>Basis:</strong>{" "}
                          {ob.statutoryBasis}
                        </div>
                      )}
                    </td>
