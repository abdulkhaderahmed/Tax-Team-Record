...
export function OwnershipAndControls(data: OwnershipControlsData) {
  ...
  return (
    <div className="panel">
      ...
      <h3 style={{ fontSize: 13, color: "#6b7280", textTransform: "uppercase", marginBottom: 8 }}>RACI</h3>
      ...
      {(["Responsible", "Accountable", "Consulted", "Informed", "External adviser", "External operational owner"] as RaciRole[]).map((role) => {
        ...
        return (
          <div key={role} style={{ marginBottom: 8 }}>
            <span style={{ fontSize: 12, fontWeight: 600, color: "#6b7280" }} title={RACI_ROLE_DEFINITIONS[role]}>{role}:</span>{" "}
            {assignments.map((a) => (
              <span key={a.id} className="badge badge-grey" style={{ marginRight: 6 }}>
                ...
                <form action={removeRaciAssignment.bind(null, a.id, data.returnPath)} style={{ display: "inline" }}>
                  <button type="submit" style={{ border: "none", background: "none", cursor: "pointer", marginLeft: 4, color: "#b91c1c" }} title="Remove">×</button>
                </form>
              </span>
            ))}
          </div>
      ...
      <h3 style={{ fontSize: 13, color: "#6b7280", textTransform: "uppercase", margin: "16px 0 8px" }}>Required status flags</h3>
      ...
      <h3 style={{ fontSize: 13, color: "#6b7280", textTransform: "uppercase", margin: "16px 0 8px" }}>Statuses</h3>
      ...
      <h3 style={{ fontSize: 13, color: "#6b7280", textTransform: "uppercase", margin: "16px 0 8px" }}>Status history</h3>
