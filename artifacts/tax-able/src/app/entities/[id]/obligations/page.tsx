  ...
  return (
    <>
      ...
      <div className="panel" style={{ padding: "12px 16px", marginBottom: 16 }}>
        <div style={{ display: "flex", gap: 24, flexWrap: "wrap", fontSize: 12, color: "var(--ink-secondary)" }}>
          <span>
            <strong style={{ color: "var(--ink-secondary)" }}>CT regime:</strong>{" "}
            {entity.isVeryLargeCompany ? "Very large (QIPs)" : entity.isLargeCompany ? "Large" : "Standard"}
          </span>
          <span>
            <strong style={{ color: "var(--ink-secondary)" }}>VAT:</strong>{" "}
          ...
          <span>
            <strong style={{ color: "var(--ink-secondary)" }}>ERS:</strong>{" "}
            {entity.hasErs ? "Yes" : "No"}
          </span>
          <span>
            <strong style={{ color: "var(--ink-secondary)" }}>Pillar 2:</strong>{" "}
