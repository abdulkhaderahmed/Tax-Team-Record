      ...
      <div style={{ padding: "28px 32px", maxWidth: 760 }}>
        ...
        <form action={createSourceConflict}>
          <div className="panel" style={{ marginBottom: 20 }}>
            ...
            <div className="form-row">
              <label className="form-label">
                Data category <span style={{ color: "var(--overdue)" }}>*</span>
              </label>
          ...
          <div className="panel" style={{ marginBottom: 20 }}>
            ...
            <div className="form-row">
              <label className="form-label">
                Source system A <span style={{ color: "var(--overdue)" }}>*</span>
              </label>
            ...
            <div className="form-row">
              <label className="form-label">
                Value from Source A <span style={{ color: "var(--overdue)" }}>*</span>
              </label>
          ...
          <div className="panel" style={{ marginBottom: 20 }}>
            ...
            <div className="form-row">
              <label className="form-label">
                Source system B <span style={{ color: "var(--overdue)" }}>*</span>
              </label>
            ...
            <div className="form-row">
              <label className="form-label">
                Value from Source B <span style={{ color: "var(--overdue)" }}>*</span>
              </label>
