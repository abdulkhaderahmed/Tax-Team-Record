# TaxGPT → UK Tax → Tax-Able: Analysis & Build Plan
...
for UK tax law and integrating it into Tax-Team-Record / Tax-Able.
...
| [04-tax-able-integration-and-improvements.md](04-tax-able-integration-and-improvements.md) | Mapping TaxGPT concepts onto Tax-Able's extraction → review → live-object flow; ranked improvements (review-queue training-data flywheel, inline validators, extraction benchmark, provider abstraction, reviewer RAG); proposal to house the model pipeline in the empty `tax-able` repo; merged roadmap. |
...
reviews — not its weights. Port the discipline into Tax-Able first (immediate product wins),
